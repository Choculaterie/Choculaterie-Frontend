...
export type GetApiAdminServerLogsParams = {
/**
 * @pattern ^-?(?:0|[1-9]\d*)$
 */
page?: number | string;
...
export type GetFilesSignParams = {
path?: string;
};
...
export type GetApiMojangProxyMinecraftProfileParams = {
username?: string;
};
...
export type PutQsIdScreenshotBody = {
  file?: IFormFile;
};
